    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCreate.setOnClickListener {
            ...
            if (TextUtils.isEmpty(name.text.toString()) || TextUtils.isEmpty(email.text.toString()) || TextUtils.isEmpty(password.text.toString())) {
                Toast.makeText(this@Create, "Por favor preencha todos os campos.", Toast.LENGTH_LONG).show()
                ...
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    ...
                    if (body == null) {
                        ...
                        try {
                            ...
                            Toast.makeText(this@Create, "Erro ao salvar usuário. (JSONObject)", Toast.LENGTH_LONG).show()
                        }
